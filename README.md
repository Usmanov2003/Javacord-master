...
The awesome people that contributed to Javacord in the past can be found ✨here✨
...
Command Framework by @Vampire
A generic CDI-based command framework.
Discord Interaction Handler by @felldo
